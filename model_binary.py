...
import json
import numpy as np
from generator_binary import DataGenerator
import tensorflow
...
def base_model(kernel_size,lambda_rate,x,y,kernel_initializer):
	...
	output = Dense(1, activation='sigmoid',name='output_layer')(fnn)
...
if __name__ == "__main__":
	...
	model.fit_generator(generator=training_generator,epochs=25,validation_data=validation_generator,
